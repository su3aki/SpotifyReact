    ...
    <div className={classes.root}>
      <div className="tracks">
        ...
        {artistInfo.length !== 0
          ...
          trackName={selectedTrack.trackName}
          trackArtistId={selectedTrack.trackArtistId}
          trackArtistName={selectedTrack.trackArtistName}
          trackArtworkUrl={selectedTrack.trackArtworkUrl}
          trackPopularity={selectedTrack.trackPopularity}
          />}
